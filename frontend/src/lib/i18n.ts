...
export const dict: Record<string, Dict> = {
  ...
  "nav.transactions": {
    "uz-Latn": "To'lov hisoboti",
    "uz-Cyrl": "Тўлов ҳисоботи",
    ru: "Отчёт по оплатам",
    en: "Payment Report",
  },
  "nav.users": {
    "uz-Latn": "Foydalanuvchilar",
    "uz-Cyrl": "Фойдаланувчилар",
    ru: "Пользователи",
    en: "Users",
  },
  "nav.settings": {
  ...
  "users.description": {
    "uz-Latn": "Tizimdagi barcha foydalanuvchilar faoliyati statistikasi",
    "uz-Cyrl": "Тизимдаги барча фойдаланувчилар фаолияти статистикаси",
    ru: "Статистика деятельности всех пользователей системы",
    en: "All system users activity statistics",
  },
  "users.col.username": {
    "uz-Latn": "Login",
    "uz-Cyrl": "Логин",
  ...
  "users.col.payments": {
    "uz-Latn": "To'lov olgan",
    "uz-Cyrl": "Тўлов олган",
    ru: "Принял платежей",
    en: "Payments taken",
  },
  "users.col.lastLogin": {
    "uz-Latn": "Oxirgi kirish",
    "uz-Cyrl": "Охирги кириш",
    ru: "Последний вход",
    en: "Last login",
  },
  "users.totalSummary": {
    "uz-Latn": "Jami: {users} foydalanuvchi, {debts} ta qarz ({debtAmount}), {payments} ta to'lov ({paymentAmount})",
    "uz-Cyrl": "Жами: {users} фойдаланувчи, {debts} та қарз ({debtAmount}), {payments} та тўлов ({paymentAmount})",
    ru: "Всего: {users} пользователей, {debts} долгов ({debtAmount}), {payments} платежей ({paymentAmount})",
    en: "Total: {users} users, {debts} debts ({debtAmount}), {payments} payments ({paymentAmount})",
  },
  "users.detail.title": {
    "uz-Latn": "Foydalanuvchi tafsiloti",
    "uz-Cyrl": "Фойдаланувчи тафсилоти",
    ru: "Детальная информация",
    en: "User details",
  },
  "users.detail.debts": {
    "uz-Latn": "Yozgan qarzlari",
    "uz-Cyrl": "Ёзган қарзлари",
    ru: "Добавленные долги",
    en: "Recorded debts",
  },
  "users.detail.payments": {
    "uz-Latn": "Olgan to'lovlari",
    "uz-Cyrl": "Олган тўловлари",
    ru: "Принятые платежи",
    en: "Recorded payments",
  },
  "users.detail.audit": {
    "uz-Latn": "Faoliyat tarixi",
    "uz-Cyrl": "Фаолият тарихи",
    ru: "История действий",
    en: "Activity history",
  },
  "users.detail.client": {
  ...
  "transactions.description": {
    "uz-Latn": "Barcha qarz va to'lov harakatlari xronologik tartibda",
    "uz-Cyrl": "Барча қарз ва тўлов ҳаракатлари хронологик тартибда",
    ru: "Все движения долгов и платежей в хронологическом порядке",
    en: "All debt and payment transactions in chronological order",
  },
  "transactions.col.client": {
    "uz-Latn": "Mijoz",
    "uz-Cyrl": "Мижоз",
    ru: "Клиент",
    en: "Client",
  ...
  "transactions.col.admin": {
    "uz-Latn": "Admin",
    "uz-Cyrl": "Админ",
    ru: "Админ",
    en: "Admin",
  },
  "transactions.col.branch": {
    "uz-Latn": "Filial",
    "uz-Cyrl": "Филиал",
    ru: "Филиал",
    en: "Branch",
  ...
  "transactions.filterDebts": {
    "uz-Latn": "Qarzlar",
    "uz-Cyrl": "Қарзлар",
    ru: "Долги",
    en: "Debts",
  },
  "transactions.filterPayments": {
    "uz-Latn": "To'lovlar",
    "uz-Cyrl": "Тўловлар",
    ru: "Платежи",
    en: "Payments",
  },
  "transactions.filterAll": {
    "uz-Latn": "Barchasi",
    "uz-Cyrl": "Барчаси",
    ru: "Все",
    en: "All",
  },
  "transactions.summaryDebts": {
    "uz-Latn": "Jami qarz",
    "uz-Cyrl": "Жами қарз",
    ru: "Всего долгов",
    en: "Total debts",
